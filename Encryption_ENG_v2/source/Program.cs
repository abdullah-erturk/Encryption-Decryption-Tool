    ...
    class CryptWork
    {
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("");
                    Console.WriteLine("Encryption in progress, please wait...");
                    Console.WriteLine("");
                ...
                {
                    Console.WriteLine("");
                    Console.WriteLine("Decryption in progress, please wait...");
                    Console.WriteLine("");
            ...
            catch (FileNotFoundException ex)
            {
                ...
                Console.WriteLine("");
                Console.WriteLine("Will close automatically in 3 seconds.");
        ...
        static void ShowUsage()
        {
           using (RegistryKey key = Registry.ClassesRoot.CreateSubKey(@".enc\DefaultIcon"))
            ...
            Console.WriteLine("");
            Console.WriteLine("");
            Console.WriteLine("Encrypt or decrypt any file on the Windows environment with a password you specify.");
            Console.WriteLine("");
            Console.WriteLine("");
            ...
            if (File.Exists(encryptExePath))
            {
                while (true)
                {
                    Console.WriteLine("Program is already installed. Do you want to uninstall it? (y/n)");
                    Console.WriteLine("");
                    ...
                    {
                        Console.WriteLine("");
                        Console.WriteLine("Program uninstallation canceled.");
                         Console.WriteLine("");
                        Console.WriteLine("Press ENTER to exit.");
                        break;
                    }
            ...
            else
            {
                while (true)
                {
                    ...
                    Console.WriteLine("n = Cancels the installation process");
                    Console.WriteLine("");
                    Console.Write("Your choice: ");
                    string answer = Console.ReadLine();
        ...
        static void EncryptFile(string inputFilePath, byte[] aesKey, byte[] password, byte[] salt)
        {
            if (inputFilePath.EndsWith(".enc"))
            {
                Console.WriteLine("WARNING : File is already encrypted, cannot be encrypted again.");
                Console.WriteLine("");
                Console.WriteLine("Will close automatically in 4 seconds.");
                Thread.Sleep(4000);
                Environment.Exit(0);
            }
            ...
            try
            {
                ...
                using (var provider = new AesCryptoServiceProvider())
                {
                    ...
                    {
                        // Calculate and write the hash of user-entered password and salt values
        ...
        static async Task<string> ReadPasswordAsync()
        {
            ...
            while (true)
            {
                if (Console.KeyAvailable)
                {
                 ...
                 await Task.Delay(10); // Adding a short delay
            }
